      ...
      <div className={globalStyles.modalBody}>
        <div className={globalStyles.formTwoColumn}>
          <div className={globalStyles.formGroup}>
            ...
            <input {...register("first_name")} autoFocus className={globalStyles.input} />
        ...
        <div className={globalStyles.formGroup}>
          ...
          <input {...register("username")} className={globalStyles.input} disabled />
        ...
        <div className={globalStyles.formGroup}>
          ...
          <textarea {...register("bio")} className={globalStyles.input} rows={4}></textarea>
