...
const Profile = ({ profile }: ProfileProps) => {
  ...
  const [activeSection, setActiveSection] = useState<ActiveSectionProps | null>(null);
        ...
        <Container margin>
          {activeSection && (
            <Modal
              ...
              onClose={closeModal}
            >
              {activeSection.title === "Details" && <DetailsModalForm closeModal={closeModal} />}
              ...
              {activeSection.title === "Skills" && <SkillsModalForm closeModal={closeModal} />}
          ...
          {section == "Projects" && (
            <Projects projects={profile.projects} action={openModal} profile={profile} />
          )}
          ...
          {section == "About" && <AboutSection profile={profile} openModal={openModal} />}
        </Container>
      </>
    );
  }
...
export const getServerSideProps = async (context: any) => {
  const res = await fetch(`${server}/api/profiles/${context?.params?.username}/`);
